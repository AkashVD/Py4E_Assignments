...
# Actual problem: Start at: http://py4e-data.dr-chuck.net/known_by_Kaydie.html
...
# Function to open webpage and retrieves the anchor tags
def retriever(url):
...
url = input("Enter URL: ")
count_val = int(input("Enter count: "))
